...
{
    public class FCWindow_RenameSquad : Window
    {
        private readonly MilSquadFC squad;
        private string curName;
        private bool focusedField;

        public override Vector2 InitialSize => new Vector2(300f, 175f);

        public FCWindow_RenameSquad(MilSquadFC squad)
        {
            this.squad = squad;
            curName = squad.name;
            doCloseX = true;
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(new Rect(0, 0, inRect.width, 35f), "FCRenameSquad".Translate());
